...
func getInstanbulInstructions() map[vm.OpCode]InstructionInfo {
	...
	res := map[vm.OpCode]InstructionInfo{
		...
		vm.SWAP1:          {stack: swap(2), gas: gasS(gasFastestStep)},
		vm.SWAP2:          {stack: swap(3), gas: gasS(gasFastestStep)},
		vm.SWAP3:          {stack: swap(4), gas: gasS(gasFastestStep)},
		vm.SWAP4:          {stack: swap(5), gas: gasS(gasFastestStep)},
		vm.SWAP5:          {stack: swap(6), gas: gasS(gasFastestStep)},
		vm.SWAP6:          {stack: swap(7), gas: gasS(gasFastestStep)},
		vm.SWAP7:          {stack: swap(8), gas: gasS(gasFastestStep)},
		vm.SWAP8:          {stack: swap(9), gas: gasS(gasFastestStep)},
		vm.SWAP9:          {stack: swap(10), gas: gasS(gasFastestStep)},
		vm.SWAP10:         {stack: swap(11), gas: gasS(gasFastestStep)},
		vm.SWAP11:         {stack: swap(12), gas: gasS(gasFastestStep)},
		vm.SWAP12:         {stack: swap(13), gas: gasS(gasFastestStep)},
		vm.SWAP13:         {stack: swap(14), gas: gasS(gasFastestStep)},
		vm.SWAP14:         {stack: swap(15), gas: gasS(gasFastestStep)},
		vm.SWAP15:         {stack: swap(16), gas: gasS(gasFastestStep)},
		vm.SWAP16:         {stack: swap(17), gas: gasS(gasFastestStep)},
