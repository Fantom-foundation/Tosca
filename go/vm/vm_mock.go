...
//
//	mockgen -source vm.go -destination vm_mock.go -package vm
//
...
func (m *MockVirtualMachine) Run(arg0 Parameters) (Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVirtualMachineMockRecorder) Run(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockVirtualMachine)(nil).Run), arg0)
}
...
// Run mocks base method.
func (m *MockProfilingVM) Run(arg0 Parameters) (Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Run", arg0)
	ret0, _ := ret[0].(Result)
	ret1, _ := ret[1].(error)
...
// Run indicates an expected call of Run.
func (mr *MockProfilingVMMockRecorder) Run(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockProfilingVM)(nil).Run), arg0)
}
