...
func (e *EvmcSteppableInterpreter) StepN(contract *vm.Contract, revision evmc.Revision, gasRefund uint64, input []byte, stepStatus evmc.StepStatus, pc uint64, stack []byte, memory []byte, numSteps int, readOnly bool) (evmc.StepResult, error) {
